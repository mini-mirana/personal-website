...
export function Effects() {
  ...
  const { rtA, rtB } = useMemo(() => {
    ...
    const a = new THREE.WebGLRenderTarget(size.width, size.height)
    const b = new THREE.WebGLRenderTarget(size.width, size.height)
    return { a, b }
  }, [size])
  ...
  return (
    <effectComposer ref={composer} args={[gl]}>
      ...
      <savePass attachArray='passes' ref={savePass} needsSwap />
      <shaderPass
        attachArray='passes'
        args={[FXAAShader]}
